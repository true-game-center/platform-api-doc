...
| gameSessionId |  String | 否 | Game session ID generated by the game side, optional |
| roundId | String | 否 | Round ID used to link debit and credit records, optional but recommended |
| tickId | String | 否 | Tick/sub-event ID, optional and only needed for tick-based games |
| transactionId | String | 否 | order transactionId |
